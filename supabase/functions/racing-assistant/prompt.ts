/** @param knowledgeBlock Text from DB (`site_content`) or bundled `knowledge.ts` — not generated by the LLM. */
...
- Stay grounded in the KNOWLEDGE BASE below; add only widely accepted general education.
