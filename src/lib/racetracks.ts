...
export const RACETRACK_WEBSITE_BY_CODE: Record<string, string> = {
  ...
  CMR: "https://www.hipodromo-camarero.com",
...
export const RACETRACK_WEATHER_BY_CODE: Record<string, RacetrackWeatherLocation> = {
  AP: { latitude: 42.0953, longitude: -87.9822, timezone: "America/Chicago" },
  ...
  CBY: { latitude: 44.7919, longitude: -93.4781, timezone: "America/Chicago" },
  ...
  CNL: { latitude: 37.5272, longitude: -77.0064, timezone: "America/New_York" },
  CRC: { latitude: 25.9786, longitude: -80.1394, timezone: "America/New_York" },
  ...
  DEL: { latitude: 39.7106, longitude: -75.6578, timezone: "America/New_York" },
  DM: { latitude: 32.9753, longitude: -117.2606, timezone: "America/Los_Angeles" },
  DMR: { latitude: 32.9753, longitude: -117.2606, timezone: "America/Los_Angeles" },
  EL: { latitude: 37.8872, longitude: -87.5714, timezone: "America/Chicago" },
  ELP: { latitude: 37.8872, longitude: -87.5714, timezone: "America/Chicago" },
  EM: { latitude: 47.3289, longitude: -122.2378, timezone: "America/Los_Angeles" },
  EV: { latitude: 30.5292, longitude: -92.0819, timezone: "America/Chicago" },
  ...
  GG: { latitude: 37.8839, longitude: -122.3122, timezone: "America/Los_Angeles" },
  GP: { latitude: 25.9786, longitude: -80.1394, timezone: "America/New_York" },
  GPW: { latitude: 25.9786, longitude: -80.1394, timezone: "America/New_York" },
  HAW: { latitude: 41.8294, longitude: -87.7447, timezone: "America/Chicago" },
  HOL: { latitude: 33.9461, longitude: -118.3386, timezone: "America/Los_Angeles" },
  ...
  PID: { latitude: 42.0511, longitude: -80.0692, timezone: "America/New_York" },
  ...
  RP: { latitude: 35.5356, longitude: -97.4683, timezone: "America/Chicago" },
  ...
  SUN: { latitude: 31.8072, longitude: -106.5608, timezone: "America/Denver" },
  TAM: { latitude: 28.0497, longitude: -82.6483, timezone: "America/New_York" },
  TD: { latitude: 41.4117, longitude: -81.5364, timezone: "America/New_York" },
  TUP: { latitude: 33.4806, longitude: -111.9808, timezone: "America/Phoenix" },
