...
const sections: {
  ...
  },
  {
    ...
    title: "“In the money”",
    paragraphs: [
      'A horse is “in the money” when it finishes 1st, 2nd, or 3rd. Win is 1st; Place is 2nd; Show is 3rd — Win, Place, and Show bets all correspond to being "in the money”.',
    ],
  },
  {
    id: "lesson-1",
    ...
    paragraphs: [
      ...
      "Down the middle of the sheet, opening odds appear for each horse. Those are initial morning-line odds set ahead of time by track authorities. If a horse attracts more money from bettors, its odds shorten (smaller payout if it wins); if a horse is ignored by bettors, odds lengthen (larger payout).",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <>
        If you see that marker, treat it as “no usable prediction from this algorithm for this horse,” not as proof the horse is bad. Runners with an 'X' marker{" "}
        <span className="underline underline-offset-4 decoration-primary/80">
          will always be grouped toward the bottom of the list for layout only
        </span>
        ; it does not mean the horse has a poor chance to finish “in the money,” it only means the algorithm cannot give a prediction for the horse.
      </>,
